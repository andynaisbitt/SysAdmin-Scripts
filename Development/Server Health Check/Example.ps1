...
$ServerListFile = "C:\Scripts\PowerShell\computer.txt"  
...
$Outputreport | out-file "C:\Scripts\Powershell\HealthCheck.htm" 

Invoke-Expression "C:\Scripts\Powershell\HealthCheck.htm"
